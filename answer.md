...
1. 非西醫院欲透明顯示醫院內每間診間於各時段的主治醫生、護理師以及該時段主治醫師的病人名單。請同學參考Topic 4投影片，請先寫出「目標與使用案例表」，之後依照使用案例格式，對「目標與使用案例表」中的所有使用案例，撰寫單欄式敘述。以下為討論隨筆簡述：
 ...
 -----------------------------   
    ...
    |  使用案例描述  | 顯示病人資訊  |
    | 主要參與者 | 醫師 護理師 病人 |
    | 利害關係人與目標 | 醫師和護理師可透過查詢病人資訊來了解病情<br>病人可以查到自己得資料是否正確 |
    | 前置條件  | 病人有提供健保卡 |
    | 後置條件  | 正確查詢到病人資料 |
    | 主要成功情節  | 1.病人已掛號並提供健保卡<br>2.系統透過健保卡建立病人資訊<br>3.醫師與護理師可透過病人健保卡來查詢該病人資料 |
    | 例外情節 | 病人資料需要更新 |
    | 其他需求 | 無 |
...
需要學會案例表的應用、記錄利害關係人與目標，不僅要將流程完整地紀錄下來，同時也要把過程濃縮成淺顯易懂的圖形或表格。